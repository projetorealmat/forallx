...
\item[B:] Bob é um espião.
\item[C:] O código foi decifrado.
\item[G:] A embaixada brasileira ficará em alvoroço.
\end{ekey}
\begin{earg}
...
$(A \eor B) \eif C$
\item %Se nem Alice nem Bob forem espiões, então o código permanece indecifrado.
$\enot(A \eor B) \eif \enot C$
\item %A embaixada brasileira ficará em alvoroço, a menos que alguém tenha decifrado o código.
$G \eor C$
\item %Ou o código foi decifrado ou não foi, mas a embaixada brasileira ficará em alvoroço de qualquer maneira.
$(C \eor \enot C) \eand G$
