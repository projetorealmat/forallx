...
A lógica é o ramo que estuda a avaliação de argumentos, separando os bons dos ruins. Na linguagem do dia a dia, às vezes usamos a palavra 'argumento' para nos referir a brigas barulhentas e cheias de hostilidade. Se você e um amigo têm uma discussão nesse sentido, as coisas não vão bem entre vocês.
...
\end{earg}
Este é um argumento muito sólido. A única maneira de contestar a conclusão é negando uma das premissas — a forma lógica é impecável. E quanto ao argumento seguinte?
...
Algumas linguagens formais levam isso em conta permitindo lacunas de valor de verdade: sentenças que não são nem verdadeiras nem falsas. Outras — as chamadas lógicas paraconsistentes — permitem sobras de valor de verdade: sentenças que são verdadeiras e falsas ao mesmo tempo. A paraconsistência diz respeito à possibilidade de raciocinar com contradições sem que toda sentença se torne derivável; ela não implica, por si só, que alguma sentença seja simultaneamente verdadeira e falsa. Essa última possibilidade é discutida, por exemplo, no dialeteísmo.
