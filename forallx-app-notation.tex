...
Em um sentido, os símbolos usados para várias constantes lógicas são arbitrários. Não há nada escrito no céu que diga que `\enot' deve ser o símbolo para negação verofuncional. Poderíamos ter especificado um símbolo diferente para desempenhar esse papel. Uma vez que demos definições para fórmulas bem formadas (FBFs) e para verdade em nossas linguagens lógicas, no entanto, usar `\enot' não é mais arbitrário. Esse é o símbolo para negação neste livro, e portanto é o símbolo para negação ao escrever sentenças em nossas linguagens LS ou LQ.
