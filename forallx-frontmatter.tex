...
\href{https://github.com/projetorealmat}{%
  \includegraphics[width=0.28\textwidth]{assets/realmat-logo.png}%
}
...
\href{https://github.com/projetorealmat}{%
  \includegraphics[width=\linewidth]{assets/realmat-logo.png}%
}
\end{minipage}\hfill
\begin{minipage}[c]{0.72\textwidth}
{\sf
\textbf{Projeto REALMat}\\
Esta tradução e adaptação brasileira foi desenvolvida no âmbito do projeto REALMat --- Recursos Educacionais Abertos na Licenciatura em Matemática.\\
\url{https://github.com/projetorealmat}\\
